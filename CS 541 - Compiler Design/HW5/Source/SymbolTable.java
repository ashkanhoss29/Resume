...
// grader: should be Map<String,Symb> here and elsewhere.  -1
  ...
  public final void openScope() {
    final Map<String, Symb> myMap = new HashMap<String, Symb>();
    scopes_.add(myMap);
  }
   ...
   * @throws EmptySTException if the list of scopes is empty
   */
  public void insert(final Symb symbol) 
          throws DuplicateException, EmptySTException {
    if(scopes_.isEmpty()) {
      throw new EmptySTException();
    }
    
    final Map<String, Symb> currentScope = scopes_.getLast();
   ...
   * @throws EmptySTException if the list of scopes is empty
   */
  public Symb localLookup(final String symbolName) 
          throws EmptySTException {
    if(scopes_.isEmpty()) {
      throw new EmptySTException();
    }
   ...
   * with symbolName
   */
  public Symb globalLookup(final String symbolName) {
    ...
    while(iterator.hasNext()) {
      final Map<String, Symb> scope = iterator.next();
  ...
  public String toString() {
    ...
    while(iterator.hasNext()) {
      ...
      for(String name : nameSet) {
        final Symb symbol = scope.get(name);
