...
int init_resources(void)
{
  ...
  const char *fs_source =
	...
	"uniform float y_min;"
    "void main(void) {                                                     "
	"  float x0 = ((float(gl_FragCoord.x) * (x_max - x_min)) / 1920.0) + x_min;  "
	"  float y0 = ((float(gl_FragCoord.y) * (y_max - y_min)) / 1080.0) + y_min;  "
	"  float hello = 0.0;                                                  "
	"  float x = 0.0; "
	"  float y = 0.0;                                                      "
	"  float xtemp = 0.0;                                                  "
