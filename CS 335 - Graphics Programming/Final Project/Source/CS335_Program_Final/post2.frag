...
float focalDepth = 100.0;  //focal distance value in meters, but you may use autofocus option below
float fstop = 10.0; //f-stop value
...
float znear = 0.15; //camera clipping start
...
float fringe = 3.0; //bokeh chromatic aberration/fringing
